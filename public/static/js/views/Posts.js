...
export default class extends AbstractView {
    ...
    async getHtml() {
        return `
            ...
            <!-- Additional rows of added songs -->
            <div class="row mt-2">     
            ...
            <div class="song-list">
                <div class="row">
                    <div class="col">
                        <div class="song-info">
                            <img src="https://www.fubiz.net/wp-content/uploads/2018/01/01-kendrick-lamar-damn-album-art-2017-billboard-1240.jpg" alt="Album Cover">
                            <p>Song Name</p>
                            <p>Artist Name</p>
                            <p>Genre</p>
                            <p>Date Added</p>
                ...
                <!-- Repeat this row structure for additional songs -->
            </div>
        `;
    }
}